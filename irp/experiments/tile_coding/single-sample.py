...
for coord in coords:
    ...
    n_subimages, n_sublabels = irp.utils.get_neighborhood_images(
        subimages, sublabels, coord, subimage_width, subimage_height, overlap, n_size, (512, 512)
    )
...
print(sklearn.metrics.f1_score(real_label.astype(bool).flatten(), result.astype(bool).flatten()))
